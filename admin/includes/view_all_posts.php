        ...
        <a href="posts.php?source=add_post" class="btn btn-primary">Add New</a>
                ...
                <?php
                    ...
                    while ($row=mysqli_fetch_assoc($select_posts)) {
                        ...
                        echo "<td><a class='btn btn-success btn-xs'  href='../post.php?p_id={$post_id}'>View Post</a></td>";
                        echo "<td><a class='btn btn-info btn-xs'  href='posts.php?source=edit_post&p_id={$post_id}'>Edit</a></td>";
                        echo "<td><a rel='{$post_id}' href='javascript:void(0)' class='delete_link btn btn-danger btn-xs'>Delete</a></td>";
                        // echo "<td><a onClick=\"javascript: return confirm('Do you want to delete?') \" href='posts.php?delete={$post_id}'>Delete</a></td>";
